	  ...
	  */
	   ...
	   */
	    ...
	    */
	     ...
	     * of the parent node
	     */
	     private int getIndex(BoundingShape boundingShape) {
	      ...
	      */
	      public void insert(BoundingShape boundingShape) {
	        if (nodes[0] != null) {
	          int index = getIndex(boundingShape);
	      
	          if (index != -1) {
	            nodes[index].insert(boundingShape);
	        ...
	        if (objects.size() > MAX_OBJECTS && level < MAX_LEVELS) {
	          ...
	          while (i < objects.size()) {
	            ...
	            if (index != -1) {
	              ...
	              //System.out.println("Added to level: " + (level + 1) + ", Index: " + index);
	            }
	            else {
	              i++;
	            }
	       ...
	       */
	       public ArrayList<BoundingShape> retrieve(ArrayList<BoundingShape> returnObjects, BoundingShape boundingShape) {
	         int index = getIndex(boundingShape);
	         if (index != -1 && nodes[0] != null) { //nodes[0]
	           nodes[index].retrieve(returnObjects, boundingShape);
	         }
